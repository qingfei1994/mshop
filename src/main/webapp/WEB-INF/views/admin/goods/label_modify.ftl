	        ...
	        <div class="form-body">
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        ...
                        <input  type="hidden" class="form-control" name="golaId" value="${golaId!}" required="true">
                            <label  class="col-md-3 control-label">标签名称<span class="required">*</span></label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="golaName" value="${golaName!}" required="true">
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="col-md-3 control-label">排序<span class="required">*</span></label>
                            <div class="col-md-6">
                                <input type="text" class="form-control"  name="golaSort"  value="${golaSort!}" required="true" digits="true">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button url="admin/goods/label/save"
