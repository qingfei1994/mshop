    	...
    	<form class="form-horizontal ajax-form valid" id="addGroupForm" role="form">
	        <div class="form-body">
                ...
                <div class="modal-body">
                    ...
                    <input id="goclId" type="hidden" name="ingrId" value="${(group.ingrId)!}">
                    <div class="col-md-12">
                        <div class="form-group">
							<label for="name"  class="col-md-3 control-label" >分组名称<span class="required">*</span></label>
			  				<div class="col-md-9">
			  					<input id="addGoclName" type="text" name="ingrName" required="true" maxlength="10" class="form-control" placeholder="请输入分组名称" value="${(group.ingrName)!}">
				  	...
				  	<#if flag='edit'>
						<div class="form-group">
							...
							<div class="col-md-9">
								<img name="ingrIconUrl" value="${group.ingrIconUrl!}" src="${group.ingrIconUrl!}" style="margin-left:6px;"width="78" height="78"></img>
							</div>
						</div>
					</#if>
				  	<div class="col-md-12">
                ...
                <div class="modal-footer">
                    ...
                    <button id="addClassification" url="<#if flag=='edit'>admin/shop/show/edit<#elseif flag='add'>admin/shop/show/add</#if>" type="button" class="btn btn-success ajax-submit-modal">确定</button>
                </div>
            </div>
    	</form>
    </div>
