					...
					<div class="comments-block">
						...
						<#if goodsOrder.goodsComment??>
                            ...
                            <div class="comments-text">
                                <span>内容</span>
                                <span><textarea id="comments1" name="content" placeholder="你的评价将会对其他买家很有帮助~" maxlength="200" readonly>${goodsOrder.goodsComment.gocoCommentContent}</textarea></span>
                            </div>
                            <#if goodsOrder.goodsComment.gocoReplyContent??>
                            	<div class="comments-text">
                                <span>回复</span>
                                <span><textarea id="comments1" name="content"  maxlength="200" readonly>${goodsOrder.goodsComment.gocoReplyContent}</textarea></span>
                            </div>
                            </#if>
						<#else>
                            <div class="comments-stars">
